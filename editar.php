...
$dbname = "gerenciador"; // Substitua pelo nome do seu banco de dados
...
if (isset($_GET['id'])) {
    ...
    $stmt = $conn->prepare("SELECT * FROM dados WHERE id = ?");
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("UPDATE dados SET tarefa = ?, descricao = ?, prazo = ?, prioridade = ?, concluida = ?, lembrete = ? WHERE id = ?");
